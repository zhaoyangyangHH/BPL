...
class DialogManager:
    ...
    def initialize_episode(self, current_goal_len=1, complete_goal_len=1, selected_goal=None):
        ...
        self.current_goal_len = current_goal_len * 1.0
        self.complete_goal_len = complete_goal_len
        ...
        self.max_reward = 2 * self.user.max_turn * (self.current_goal_len / self.complete_goal_len)
    ...
    def next_turn(self, record_training_data=True):
        ...
        # self.instrinsic_reward = self.agent.get_intrinsic_reward(self.state, self.state_tracker.get_state_for_agent(), self.agent_action)
        # print 'intrinsic_reward', self.instrinsic_reward

        # print ('state_1', self.state)
        # print ('state_next_1', self.state_tracker.get_state_for_agent())
        # print ('action_1', self.agent_action)
        self.icm_loss = self.agent.get_icm_loss(self.state, self.state_tracker.get_state_for_agent(), self.agent_action)
    ...
    def reward_function(self, dialog_status):
        ...
        if dialog_status == dialog_config.FAILED_DIALOG:
            ...
            reward = 2*self.user.max_turn*(self.current_goal_len/self.complete_goal_len)
