...
class AgentDQN(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None):
        ...
        if params['trained_model_path'] != None:
            path = params['trained_model_path']
            ...
            self.warm_start = 2
        print "number of action1", self.num_actions
        print "action",self.feasible_actions
    ...
    def get_icm_loss(self, s_t, s_t1, a):
        return self.dqn.get_icm_loss(
                self.prepare_state_representation(s_t),
                self.prepare_state_representation(s_t1),
                np.array(self.action))
    ...
    def train(self, batch_size=1, num_batches=100):
        ...
        for iter_batch in range(num_batches):
            ...
            # icm_loss += batch_struct['icm_loss']
